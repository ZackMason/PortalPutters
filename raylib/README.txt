...
Once installed, C:\raylib self-contained portable directory is created with all the required tools:
 ...
 - C Compiler, depending on the version of the installer it could be:
     - w64devkit 1.10.0 that contains multiple tools and MinGW-w64 with GCC 11.2.0 (32bit) - https://github.com/skeeto/w64devkit
     - Zig 0.9.0-dev with Clang 13.0.0 (64bit) - https://ziglang.org/download/
     - tcc 0.9.27 (32bit and 64bit) - https://repo.or.cz/tinycc.git
 - Notepad++ 8.1.9 (npp) preconfigured with some scripts to compile raylib sources and raylib examples for the selected package compiler
 - raylib 4.0 library with source code and examples
